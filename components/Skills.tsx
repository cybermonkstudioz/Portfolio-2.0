...
import { 
  ...
  SiFastapi, SiPostgresql, SiPydantic, SiDocker
} from 'react-icons/si'
...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: 'Java', icon: FaJava, color: 'group-hover:text-[#ED8B00]' },
      { name: 'FastAPI', icon: SiFastapi, color: 'group-hover:text-[#009688]' },
      { name: 'PostgreSQL', icon: SiPostgresql, color: 'group-hover:text-[#4169E1]' },
      { name: 'Pydantic', icon: SiPydantic, color: 'group-hover:text-[#E92063]' },
      { name: 'Docker + Cloud', icon: SiDocker, color: 'group-hover:text-[#2496ED]' },
